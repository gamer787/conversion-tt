/*
  # Fix conversations function with qualified columns

  1. Changes
    - Drop existing get_conversations_v3 functions
    - Create new get_conversations_v3 function with properly qualified column references
...
BEGIN
  ...
  LEFT JOIN conversation_users cu ON cu.conversation_id = uc.conversation_id
  LEFT JOIN unread_counts un ON un.conversation_id = uc.conversation_id
...
GRANT EXECUTE ON FUNCTION public.get_conversations_v3(integer, integer) TO authenticated;