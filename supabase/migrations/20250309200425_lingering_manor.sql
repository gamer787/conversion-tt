/*
  # Update conversations function
  
  1. Changes
    - Creates a new get_conversations_v3 function that combines pagination and default functionality
    - Improves performance with optimized queries
    - Adds proper type handling for participants and messages
...
CREATE OR REPLACE FUNCTION get_conversations_v3(
  limit_val integer DEFAULT NULL,
...
BEGIN
  ...
  WITH user_conversations AS (
    ...
    LIMIT CASE 
      WHEN limit_val IS NOT NULL THEN limit_val 
      ELSE NULL 
    END
    OFFSET offset_val
  ),
