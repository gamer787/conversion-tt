/*
  ...
  3. New Functions
    ...
    - get_messages_with_info_v3
    - send_message_v3
    - mark_messages_seen_v3
    - update_typing_status_v3
...
-- Get Messages Function (v3)
CREATE OR REPLACE FUNCTION get_messages_with_info_v3(target_conversation_id text)
RETURNS TABLE (
  id uuid,
  sender_id uuid,
  content text,
...
-- Send Message Function (v3)
CREATE OR REPLACE FUNCTION send_message_v3(
...
-- Mark Messages Seen Function (v3)
CREATE OR REPLACE FUNCTION mark_messages_seen_v3(target_conversation_id text)
...
-- Update Typing Status Function (v3)
CREATE OR REPLACE FUNCTION update_typing_status_v3(
  target_conversation_id text,
  is_typing boolean
) RETURNS void SECURITY DEFINER AS $$
BEGIN
...
GRANT EXECUTE ON FUNCTION get_conversations_v3 TO public;
GRANT EXECUTE ON FUNCTION get_messages_with_info_v3 TO public;
GRANT EXECUTE ON FUNCTION send_message_v3 TO public;
GRANT EXECUTE ON FUNCTION mark_messages_seen_v3 TO public;
GRANT EXECUTE ON FUNCTION update_typing_status_v3 TO public;