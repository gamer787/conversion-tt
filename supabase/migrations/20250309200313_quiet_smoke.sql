/*
  # Update conversations functions
  
  1. Changes
    - Replaces existing get_conversations functions with a new v2 version
    - Adds pagination support
    - Improves performance with better indexing
    - Adds badge information to participants
...
-- Create new get_conversations_v2 function
...
BEGIN
  ...
  unread_counts AS (
    SELECT 
      ...
      COUNT(*) as unread
    FROM messages m
    LEFT JOIN message_receipts mr ON m.message_id = mr.message_id AND mr.user_id = v_user_id
