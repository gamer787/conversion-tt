...
CREATE INDEX idx_ad_campaigns_basic ON ad_campaigns(status);
CREATE INDEX idx_profiles_basic ON profiles(id, latitude, longitude);
CREATE INDEX idx_price_tiers_basic ON ad_price_tiers(id);